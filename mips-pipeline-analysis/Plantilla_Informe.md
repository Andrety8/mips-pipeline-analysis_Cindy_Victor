...
**Enlace del repositorio en GitHub:** https://github.com/Andrety8/mips-pipeline-analysis_Cindy_Victor.git

https://eliana-pe.github.io/Simulaci-n-Pipeline-MIPS-5-etapas-Cindy-Pena-y-Victor-Cubillos/
...
> ![MIPS X-Ray](images/MIPS-X-Ray.png)
> ![Instruction Counter](images/Instruction-Counter.png)
> ![Instruction Statistics](images/Instruction-Statistics.png)
...
> ![MIPS X-Ray Optimizado](images/mips-xray-optimized.png)
> ![Instruction Counter Optimizado](images/instruction-counter-optimized.png)
> ![Instruction Statistics Optimizado](images/instruction-statistics-optimized.png)
...
>![PPipeline Código Base](images/pipeline-codigo-base.png)
...
>![Pipeline Código Optimizado](images/pipeline-codigo-optimizado.png)
